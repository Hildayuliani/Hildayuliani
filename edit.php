...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($con , "UPDATE `tabel_pasien` SET `nomor_pasien` = '$nomor_pasien', `nama_pasien` = '$nama_pasien', `tgl_lahir` = '$tgl_lahir',
     `umur` = '$umur ', `diagnosa_penyakit` = '$diagnosa_penyakit', `nama_dokter` = '$nama_dokter', `jenis_kelamin` = '$jenis_kelamin', `jenis_pelayanan` = '$jenis_pelayanan' WHERE `tabel_pasien`.`id` = $id; ");
